...
// builder_gui.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(Cbuilder_guiApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание Cbuilder_guiApp

Cbuilder_guiApp::Cbuilder_guiApp()
{
...
// Единственный объект Cbuilder_guiApp

Cbuilder_guiApp theApp;


// инициализация Cbuilder_guiApp

BOOL Cbuilder_guiApp::InitInstance()
{
